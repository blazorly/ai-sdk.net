...
/// <summary>
/// OpenAI implementation of ILanguageModel.
/// </summary>
public class OpenAIChatLanguageModel : ILanguageModel
{
    ...
    {
        // OpenAI supports image URLs natively for vision models
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="OpenAIChatLanguageModel"/> class.
    /// </summary>
    /// <param name="modelId">The OpenAI model ID (e.g., "gpt-4", "gpt-3.5-turbo").</param>
    /// <param name="config">The OpenAI configuration.</param>
    /// <param name="httpClient">Optional HTTP client to use.</param>
    public OpenAIChatLanguageModel(
        string modelId,
    ...
    private OpenAIRequest BuildRequest(LanguageModelCallOptions options, bool stream)
    {
        ...
        if (options.Tools?.Count > 0)
        {
            ...
            {
                Tools = options.Tools.Select(t => new OpenAITool
                {
    ...
    private static Usage MapUsage(OpenAIUsage usage) => new Usage(
